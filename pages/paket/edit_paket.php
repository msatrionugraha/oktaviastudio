...
include '././koneksi.php';
$no = $_GET['no'];
        $sqlku = mysqli_query($koneksi,"select * from paket_oktavia where id_paket='$no'");
              ...
              <form role="form" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_paket" placeholder="Masukan Paket" value="<?php echo $data['nama_paket'];?>">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Masuk</label>
                    <input type="date" class="form-control" name="tgl" value="<?php echo $data['tgl_masuk'];?>" placeholder="Masukan Tanggal">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Keterangan</label>
                    <input type="text" class="form-control" name="keterangan" value="<?php echo $data['keterangan'];?>"  placeholder="Masukan Keterangan"></input>
                  </div>
                   <div class="form-group">
...
if(!empty($id_paket) and !empty($nama_paket) and !empty($keterangan) and !empty($tgl) and !empty($harga)) {
 $sql = mysqli_query($koneksi,"update paket_oktavia set id_paket = '$id_paket', nama_paket = '$nama_paket', keterangan = '$keterangan', tgl_masuk='$tgl', harga = '$harga', id_petugas = '$pet' where id_paket ='$no'");
if ($sql) {

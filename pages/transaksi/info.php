  ...
  <div class="content-wrapper">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                    ...
                    <table width="100%" style="margin-bottom: -200px;">
                                    ...
                                    include 'konek.php';
                                    $nom = 1;
                                    $sql = mysqli_query($koneksi,"select * from pembelian_head_o\ where id_beli='$idbel'");
    ...
    <tr><td colspan="6"><br></td></tr>
     <tr>
      ...
      <td>:</td>
      <td colspan="2">
        <input class="form-control" name="kurang" id="kurang" type="number" aria-describedby="emailHelp" value="<?php echo $kurang; ?>" placeholder="Kurang" onkeyup="hitung();"  readonly="">
      </td>
    </tr>
    <tr>
      <td colspan="5"></td>

...
?>
  ...
  <div class="content-wrapper">
    ...
    <tr>
      ...
      <td width="60%">: <?php echo $idbel;?><input type="text" hidden="" name="idnya" value="<?php echo $idbel;?>" readonly=""/></td>
     </tr>
     <tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td colspan="2">
        <input class="form-control" name="bayar" id="bayar" type="number" aria-describedby="emailHelp" placeholder="Bayar" onkeyup="hitung();" autofocus="">
      </td>
    </tr>
     <tr>
      <td colspan="3"></td>
      ...
      <td>:</td>
      <td colspan="2">
        <input class="form-control" name="kurang" id="kurang" type="number" aria-describedby="emailHelp" placeholder="Kurang" onkeyup="hitung();"  readonly="">
      </td>
    </tr>
    <tr>
      <td colspan="3"></td>
      ...
      <td>:</td>
      <td colspan="2">
        <input class="form-control" name="kembali" id="kembali" type="number" aria-describedby="emailHelp" placeholder="Kembali">
      </td>
    </tr>
    <tr>
      <td colspan="5"></td>
      <td>
        <a class="btn btn-primary btn-sm" style="color: white;" name="masuk" id="masuk">

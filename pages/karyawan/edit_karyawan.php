...
include '././koneksi.php';
$no = $_GET['no'];
        $sqlku = mysqli_query($koneksi,"select * from karyawan_oktavia where id_karyawan='$no'");
              ...
              <form role="form" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_kry" placeholder="Masukan Nama" value="<?php echo $data['nama'];?>">
...
if(!empty($id_kry) and !empty($nama_kry) and !empty($alamat) and !empty($no_telp) and !empty($jabatan) and !empty($gaji)) {
 $sql = mysqli_query($koneksi,"update karyawan_oktavia set id_karyawan = '$id_kry', nama = '$nama_kry', alamat = '$alamat', no_telp='$no_telp', jabatan = '$jabatan', gaji = '$gaji' where id_karyawan ='$no'");
if ($sql) {

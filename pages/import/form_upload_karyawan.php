...
<body>
 ...
 <h3><a href="../../index2.php?page=karyawan">Kembali</a></h3>
 <?php
 if (isset($_POST['upload'])) {
  ...
  foreach ($Reader as $Key => $Row)
  {
   ...
   if ($Key < 2) continue;   
   $query=mysqli_query($koneksi,"INSERT INTO karyawan_oktavia(id_karyawan,nama,alamat,no_telp,jabatan,gaji) VALUES ('".$Row[0]."', '".$Row[1]."','".$Row[2]."','".$Row[3]."','".$Row[4]."','".$Row[5]."')");
  }
  if ($query) {

...
<body>
 ...
 if (isset($_POST['upload'])) {
  ...
  foreach ($Reader as $Key => $Row)
  {
   ...
   if ($Key < 1) continue;   
   $query=mysqli_query($koneksi,"INSERT INTO akomodasi_oktavia( id_akomo,keterangan,tgl_akomo,jenis,debit,kredit) VALUES ('".$Row[0]."', '".$Row[1]."','".$Row[2]."','".$Row[3]."','".$Row[4]."','".$Row[5]."')");
  }
  if ($query) {
